...
setup(name='Test Parser',
        ...
        packages=['TestParser',
                ...
                'TestParser.View',
                'TestParser.View.Qt',
                'TestParser.View.Text',
                'TestParser.View.Tkinter',
                'TestParser_tests',
                ...
                'TestParser_tests.View.Qt',
                'TestParser_tests.View.Text',
                ],
        scripts=['src/TestParser_main.py', 'src/TestParser_unittests.py'],

        package_data={'TestParser.View.Qt' : ['*.ui'],
                        'TestParser_tests.Model': ['sample/*'],
                        'TestParser_tests.Parser': ['sample/*']},
